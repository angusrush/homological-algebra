...
\begin{definition}[cup pairing]
  \label{def:cup_pairing}
  Let \(M\) be a connected closed \(m\)-manifold with an \(R\)-orientation for some commutative ring \(R\). The \defn{cup pairing} is the composition
  \begin{equation*}
    \begin{tikzcd}
