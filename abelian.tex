...
\begin{lemma}
  ...
  Let $\mathcal{A}$ be an abelian category, and let $f$ be a morphism of short exact sequences as below.
  \begin{equation*}
    \begin{tikzcd}
      0
      \arrow[r]
...
Equivalently, we recover our category $A$ by taking zeroth homology.
\begin{equation*}
  \begin{tikzcd}
    \mathcal{A}
    \arrow[r, bend left, "\iota"]
