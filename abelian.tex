...
\begin{definition}[exact sequence]
  ...
  We say that the sequence $A \to B \to C$ above is \defn{exact} if $\phi$ is an isomorphism. We say that a complex $(C_{\bullet}, d)$ is \defn{exact} if it is exact at all positions.
\end{definition}
